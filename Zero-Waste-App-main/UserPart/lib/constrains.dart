...
const Color kDarkError = Color(0xFFD0524A);
 const kPrimaryColor = Color(0xFF0D732D);
const kAccentColor = Color(0xFF199A4A);
const kThirdColor = Color(0xFFDBF4E9);
const kForthColor = Color(0xFFB3CDC5);
 const kBlue = Color(0xFFC5E5F8);

 const kPlaceholder1 = Color(0xFFD8D8D8);
 const kPlaceholder2 = Color(0xFFF5F6F8);
 const kPlaceholder3 = Color(0xFFF4F4F6);

const kTextColor1 = Color(0xFFC9C9C9);
const kTextColor2 = Color(0xFFDEDEDE);
 const kTitle = Color(0xFF3B3B3B);
